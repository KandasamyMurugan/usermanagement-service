...
public class UserController {
    ...
    public void sendAccountActivationNotifications(User user) {
        ...
        String userEmailContent = String.format("Hello %s, your Cloud COP account is created successfully!", user.getFirstname());

		EmailMessage message = new EmailMessage();
		message.setSubject("CloudCOP account creation.");
